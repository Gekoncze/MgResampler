...
import cz.mg.resampler.gui.utilities.ComponentBuilderCache;
...
public class ObjectValuePanel<T> extends javax.swing.JPanel implements ValueObservable {
    ...
    public ObjectValuePanel(String path, Class[] classes) {
        this.path = path;
        this.values = (T[]) new Object[classes.length];
        for(int i = 0; i < classes.length; i++) values[i] = getInstance(classes[i]);
        initComponents();
        postInitComponents();
    }
    ...
    private void postInitComponents(){
        ...
        jComboBox.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                for(ChangeListener l : changeListeners) l.stateChanged(new ChangeEvent(ObjectValuePanel.this));
            }
        });
    }
    ...
    public void setValue(T value){
        ...
        // important note: this.value must NOT be set to value
    ...
    private T getInstance(Class c){
        if(c == null) return null;
        return (T) ComponentBuilderCache.getInstance().getValue(path + c.getSimpleName(), c);
    }

...
import cz.mg.resampler.resamplers.java.colordifference.ModifiedColorDifference;
...
public class ColorDifferenceConfigurationPanel extends ObjectConfigurationPanel<StretchResampler> {
    ...
    private static final Class[] DERIVED_CLASSES = new Class[]{
        ...
        ModifiedColorDifference.class
    };
    
    public ColorDifferenceConfigurationPanel(Object object, String path, String name, String getterName, String setterName) {

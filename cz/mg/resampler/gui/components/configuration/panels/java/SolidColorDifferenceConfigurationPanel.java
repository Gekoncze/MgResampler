...
public class SolidColorDifferenceConfigurationPanel extends ObjectConfigurationPanel<StretchResampler> {
    ...
    public SolidColorDifferenceConfigurationPanel(Object object, String path, String name, String getterName, String setterName) {
